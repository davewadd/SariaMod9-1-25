...
{
    public class CalmingCandle : ModItem
    {
        public override void SetStaticDefaults()
        {
            base.DisplayName.SetDefault("Calming Candle");
            base.Tooltip.SetDefault("A Candle that puts even your enemies to rest\nSpawn rates are Lowered");
        }
        public override void SetDefaults()
        {
            ...
            Item.value = 500;
            Item.createTile = ModContent.TileType<Tiles.CalmingCandleTile>();
            Item.holdStyle = 1;
        }
        public override void HoldItem(Player player)
        {
            player.Fairy().CalmMind = true;
            ...
            {
                player2.AddBuff(ModContent.BuffType<CalmMindBuff>(), 20);
            }
