...
{
    public class PurpleMoth : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if ((player.ownedProjectileCounts[ModContent.ProjectileType<PurpleMothGiant>()] > 0f))
            {
                Projectile.Kill();
            }
            ...
            {
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<PurpleMothGiant>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            ...
            if ((player.ownedProjectileCounts[ModContent.ProjectileType<PurpleHealthBar>()] <= 0f))
            {
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<PurpleHealthBar>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            if (foundTarget)
            {
