...
{
    public class GreenMoth : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if ((player.ownedProjectileCounts[ModContent.ProjectileType<GreenMothGiant>()] > 0f))
            {
                Projectile.Kill();
            }
            ...
            {
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + new Vector2(0f, 7f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<Mothdust2>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            ...
            {
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<GreenMothGiant>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            ...
            if ((player.ownedProjectileCounts[ModContent.ProjectileType<GreenHealthBar>()] <= 0f))
            {
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y + 0, 0, 0, ModContent.ProjectileType<GreenHealthBar>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            if (foundTarget)
            {
            ...
            Lighting.AddLight(Projectile.Center, Color.DarkGreen.ToVector3() * 1f);
