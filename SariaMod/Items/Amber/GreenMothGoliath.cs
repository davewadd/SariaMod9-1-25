...
{
    public class GreenMothGoliath : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + new Vector2(0f, 44f), Vector2.One.RotatedByRandom(6.2831854820251465) * 4f, ModContent.ProjectileType<Mothdust2>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                }
            }
            ...
            idlePosition.Y -= 168f; // Go up 48 coordinates (three tiles from the center of the player)
