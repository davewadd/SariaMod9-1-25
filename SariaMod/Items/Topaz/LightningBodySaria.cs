...
{
    public class LightningBodySaria : ModProjectile
    {
        ...
        internal static void SegmentAI(Projectile projectile, int offsetFromNextSegment, ref int playerMinionSlots)
        {
            ...
            int headProjType = ModContent.ProjectileType<LightningHeadSaria>();
            int bodyProjType = ModContent.ProjectileType<LightningBodySaria>();
        ...
        {
            int headType = ModContent.ProjectileType<LightningHeadSaria>();
