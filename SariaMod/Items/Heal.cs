    ...
    public class Heal : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextBool())
            {
                ...
                Dust.NewDust(new Vector2(Projectile.Center.X + radius * (float)Math.Cos(angle), (Projectile.Center.Y + 34) + radius * (float)Math.Sin(angle)), 0, 0, ModContent.DustType<Healdust>(), 0f, 0f, 0, default(Color), 1.5f);
            }//end of dust stuff
            ...
            Lighting.AddLight(Projectile.Center, Color.LightGreen.ToVector3() * 0.78f);
