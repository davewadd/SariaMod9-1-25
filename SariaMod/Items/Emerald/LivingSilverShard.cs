...
namespace SariaMod.Items.Emerald
{
    public class LivingSilverShard : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.useStyle = 1;
            Item.value = Item.sellPrice(0, 0, 600, 0);
            ...
            Item.shoot = ModContent.ProjectileType<RupeeXPassive3>();
        ...
        {
            Lighting.AddLight(Item.Center, Color.Silver.ToVector3() * 2f);
        }
        public override bool CanUseItem(Player player)
        {
            if ((player.ownedProjectileCounts[ModContent.ProjectileType<RupeeXPassive3>()] > 0f) || player.HasBuff(ModContent.BuffType<SilverRupeeBlock>()))
            {
                return false;
            }
            return true;
        ...
        {
            {
                ...
                recipe.AddIngredient(ModContent.ItemType<LivingSilverFragment>(), 3);
                recipe.Register();
            }
        }
    }
