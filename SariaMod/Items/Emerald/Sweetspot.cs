...
{
    public class Sweetspot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int GiantMoth = ModContent.ProjectileType<Emeraldspike>();
            ...
            if (player.velocity.Y <= 0 || player.ownedProjectileCounts[ModContent.ProjectileType<Emeraldspike>()] < 1f)
            {
