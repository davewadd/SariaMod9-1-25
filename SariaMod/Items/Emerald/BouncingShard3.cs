...
{
    public class BouncingShard3 : ModProjectile
    {
        ...
        {
            {
                Texture2D starTexture2 = TextureAssets.Projectile[ModContent.ProjectileType<BouncingShard3>()].Value;
                Texture2D starTexture = TextureAssets.Projectile[ModContent.ProjectileType<BouncingShard3>()].Value;
                ...
                for (int i = 1; i < base.Projectile.oldPos.Length; i++)
                {
                    ...
                    drawColor = Color.Lerp(drawColor, Color.Silver, completionRatio);
