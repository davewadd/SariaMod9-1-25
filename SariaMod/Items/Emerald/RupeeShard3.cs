...
{
    public class RupeeShard3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                if (Main.myPlayer == Projectile.owner) Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y - 0, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<BouncingShard3>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                Projectile.Kill();
            }
        ...
        {
            Projectile.Rupeedraw(((Texture2D)ModContent.Request<Texture2D>("SariaMod/Items/Emerald/RupeeShard3").Value), lightColor, Color.GhostWhite, 1);
            Projectile.RupeeGlowandFadedraw(((Texture2D)ModContent.Request<Texture2D>("SariaMod/Items/Emerald/RupeeShardMask3").Value), lightColor, Color.GhostWhite, 1);
        }
    }
}
