...
{
    public class BouncingShard : ModProjectile
    {
        ...
        {
            {
                Texture2D starTexture2 = TextureAssets.Projectile[ModContent.ProjectileType<BouncingShard>()].Value;
                Texture2D starTexture = TextureAssets.Projectile[ModContent.ProjectileType<BouncingShard>()].Value;
                ...
                for (int i = 1; i < base.Projectile.oldPos.Length; i++)
                {
                    ...
                    drawColor = Color.Lerp(drawColor, Color.Green, completionRatio);
