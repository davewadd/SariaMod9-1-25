...
{
    public class RupeeShard2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                if (Main.myPlayer == Projectile.owner) Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + 0, Projectile.position.Y - 0, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<BouncingShard2>(), (int)(Projectile.damage), 0f, Projectile.owner, player.whoAmI, base.Projectile.whoAmI);
                Projectile.Kill();
            }
